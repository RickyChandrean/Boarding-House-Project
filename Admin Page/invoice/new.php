...
$pdf->SetFont('Times','',10);
$pdf->Cell(2.5	,3,'',0,0,);
$pdf->Cell(190	,3,'BANK BCA Rec.	5125206350	a.n. Ricky Chandrean',0,1,'L');
$pdf->Cell(2.5	,3,'',0,0,);
$pdf->Cell(200	,3,'Dana/Shopeepay/Gopay/OVO	081521515366 a.n. Ricky Chandrean',0,1,'L');
...
$pdf->SetFont('Times','',10);
$pdf->Cell(2.5	,3,'',0,0,);
$pdf->MultiCell(150	,5,'Thank you for your business. Please send payment withen 3 days of receiving this invoice. There will be a 0.5% per day on late invoices. Make sure the total value of your bill is correct according to the name listed above. If you have any questions regarding this invoice, please call +6281521515366.',0,'L');
